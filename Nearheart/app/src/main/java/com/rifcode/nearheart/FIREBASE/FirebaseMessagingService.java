package com.rifcode.nearheart.FIREBASE;
...
//                                .setSmallIcon(R.drawable.icon_nearheart)
//                                .setContentTitle(notificationTitle)
//                                .setContentText(notificationMessage).
//                                        setSound(Uri.parse("android.resource://" + getApplicationContext().getPackageName() + "/" + R.raw.alert_msg));
